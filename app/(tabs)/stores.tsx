...
const STORES: Store[] = [
  ...
  },
  {
    ...
    coordinate: { latitude: 10.779, longitude: 106.7009 },
  ...
  },
  {
    ...
    coordinate: { latitude: 10.777, longitude: 106.7031 },
  ...
  },
  {
    ...
    coordinate: { latitude: 10.782, longitude: 106.6982 },
  ...
  },
  {
    ...
    coordinate: { latitude: 21.0278, longitude: 105.856 },
        ...
        {ALL_BRANDS.slice(1).map((brand) => (
          <Pressable
            ...
            style={[
              styles.chip,
              selectedBrand === brand && {
                backgroundColor: BRAND_COLORS[brand] + "33",
          ...
          >
            <Text
              style={[
                styles.chipText,
                selectedBrand === brand && { color: BRAND_COLORS[brand] },
              ]}
            >
              {brand}
            </Text>
      ...
      {selectedStore && (
        <View style={styles.storeCard}>
          <View
            style={[
              styles.brandDot,
              { backgroundColor: BRAND_COLORS[selectedStore.brand] },
            ]}
          />
